...
<div class="row">
	...
	<div class="col-md-5">
		<div class="box box-danger">
			<div class="box-header">
				<h2 class="box-title">Descripcion O.D.P 2</h2>
			</div>
			<div class="box-body">				
				<div id="detalle-indicador"></div>
			</div>
		</div>
	</div>
</div>
		...
		<div class="box box-danger">
			<div class="box-header">
				...
				<div class="btn-group pull-right">
					<button type="button" href="componentes-control-embarazadas" class="ver-pais btn btn-default">Ver pais</button>
				</div>
			</div>
			<div class="box-body">
				<div id="mapa-ceb"></div>
...
<script type="text/javascript">
	$(document).ready(function(){
				...
				series : {
					events: {
						click : function(e){
					    	...
					    	$.get('componentes-control-embarazadas/' + periodo + '/' + provincia, function(data){
		...
		$.get('control-embarazadas-resumen/' + {{ $periodo_calculado }} + '/' + '{{ $provincia }}', function(data){
					$('#detalle-ca').html(data);
		});

		$.get('descripcion-indicador', function(data){
					$('#detalle-indicador').html(data);
		});
