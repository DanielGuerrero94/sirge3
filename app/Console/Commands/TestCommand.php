...
class TestCommand extends Command {
	...
	public function handle() {
		...
		/*
	try {
	MyShellException::execute('sudo pgloader -v --debug /home/rodrigocadaval/Documents/Desktop/indicadores_de_prueba.load', $out);

	//system('sudo pgloader -v --debug /home/rodrigocadaval/Documents/Desktop/indicadores_de_prueba.load');
