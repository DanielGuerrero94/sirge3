...
class SolicitudController extends Controller {
	...
	public function listadoTable() {
		$requests = Solicitud::with(['tipos', 'estados', 'usuario', 'prioridades', 'operador']);
		return Datatables::of($requests)
			->addColumn('responsable', function ($request) {
				if (isset($request->operador->nombre)) {
					return '<span class="label label-danger">'.$request->operador->nombre.'</span>';
				}
