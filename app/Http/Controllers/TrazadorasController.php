...
class TrazadorasController extends AbstractPadronesController {
	...
	public function identificarTrazadora($nombre, $carga_archivo = null) {
		...
		if ($this->_info_archivo['trazadora'] == 7 && $periodo <= 201601) {
			$this->_info_archivo['trazadora'] = 15;
		}
	...
	public function procesarArchivo($id_subida) {
		...
		try {
			...
			if ($ins_header['trazadora'] == 7 && $this->_info_archivo['periodo'] <= 201601) {
				$new_header->trazadora = 15;
			} else {
