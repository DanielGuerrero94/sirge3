...
Route::get('eliminar-archivos-antiguos', 'LotesController@eliminarArchivosAntiguos');
...
Route::get('tablero-filtros-historico/{periodo_desde?}/{periodo_hasta?}/{provincia?}/{indicador?}', 'TableroController@mainHistorico');
Route::get('tablero-listado-historico-view/{periodo_desde}/{periodo_hasta}/{provincia}/{indicador}', 'TableroController@listadoHistoricoView');
Route::get('tablero-listado-historico-table/{periodo_desde}/{periodo_hasta}/{provincia}/{indicador}', 'TableroController@listadoHistoricoTable');
Route::get('listado-historico-descargar/{periodo_desde}/{periodo_hasta}/{provincia}/{indicador}', 'TableroController@excelHistorico');
...
Route::get('herramientas/datos-reportables', function () {return view('herramientas.datos-reportables', ['page_title' => 'Revision de datos reportables']);});
/**
 *  TELESALUD
 */
