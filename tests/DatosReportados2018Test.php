...
class DatosReportados2018Test extends TestCase
{
     ...
     *
     * @test
     * @dataProvider id8provider
     */
    public function datoReportable8($dr)
    {
        //Valida mascara
        $regex = '/[0-5]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
     ...
     *
     * @test
     * @dataProvider id9provider
     */
    public function datoReportable9($dr)
    {
        //Valida mascara
        $regex = '/[1-8]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
     ...
     *
     * @test
     * @dataProvider id10provider
     */
    public function datoReportable10($dr)
    {
        //Valida mascara
        $regex = '/0?[0-9]|1[0-4]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
     ...
     *
     * @test
     * @dataProvider id11provider
     */
    public function datoReportable11($dr)
    {
        //Valida mascara
        $regex = '/0?[1-9]|1[0-1]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
     ...
     *
     * @test
     * @dataProvider id12provider
     */
    public function datoReportable12($dr)
    {
        //Valida mascara
        $regex = '/[0-6]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
     ...
     *
     * @test
     * @dataProvider id13provider
     */
    public function datoReportable13($dr)
    {
        //Valida mascara
        $regex = '/[+-]|positiv[oa]|negativ[oa]/i';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
    }

    public function id14provider()
    {
        return [
            ['1'],
            ['2'],
     ...
     *
     * @test
     * @dataProvider id14provider
     */
    public function datoReportable14($dr)
    {
        //Valida mascara
        $regex = '/[1-7]/';
        $this->assertTrue(boolval(preg_match($regex, $dr)));
