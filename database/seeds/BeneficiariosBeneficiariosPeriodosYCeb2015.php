...
class BeneficiariosBeneficiariosPeriodosYCeb2015 extends Seeder
{
    ...
    public function run()
    {
        \DB::statement(" INSERT INTO beneficiarios.beneficiarios_periodos_y_ceb_2015(clave_beneficiario,periodo,activo,efector_asignado,ceb)
	(
		SELECT *
		FROM dblink('dbname=sirge host=192.6.0.118 user=postgres password=PN2012\$',
		    'SELECT clave_beneficiario,periodo,activo,efector_asignado,ceb
			    FROM beneficiarios.beneficiarios_periodos_y_ceb_2015')
