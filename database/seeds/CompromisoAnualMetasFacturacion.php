...
class CompromisoAnualMetasFacturacion extends Seeder
{
    ...
    public function run()
    {
        \DB::statement(" INSERT INTO compromiso_anual.metas_facturacion(id_provincia,primer_semestre,segundo_semestre,year)
	(
		SELECT *
		FROM dblink('dbname=sirge host=192.6.0.118 user=postgres password=PN2012\$',
		    'SELECT id_provincia,primer_semestre,segundo_semestre,anio
			    FROM compromiso_anual_2014.metas_facturacion')
