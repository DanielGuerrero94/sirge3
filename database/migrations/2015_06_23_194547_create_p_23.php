...
class CreateP23 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.p_23', function (Blueprint $table) {
            $table->increments('id');
            $table->char('estado' , 1);
        ...
        DB::statement('ALTER TABLE prestaciones.p_23 DROP CONSTRAINT p_23_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_23 ADD CONSTRAINT p_23_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
