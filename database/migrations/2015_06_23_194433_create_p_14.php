...
class CreateP14 extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE prestaciones.p_14 DROP CONSTRAINT p_14_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_14 ADD CONSTRAINT p_14_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
