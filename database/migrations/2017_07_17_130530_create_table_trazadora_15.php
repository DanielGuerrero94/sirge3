...
class CreateTableTrazadora15 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trazadoras.trz_15', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index('numero_documento', 'idx_documento_trz_15');
