...
class CreateP02 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.p_02', function (Blueprint $table) {
            $table->increments('id');
            $table->char('estado' , 1);
        ...
        DB::statement('ALTER TABLE prestaciones.p_02 DROP CONSTRAINT p_02_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_02 ADD CONSTRAINT p_02_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
