...
class CreatePrestacionesDoiLiquidadasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.prestaciones_doi_liquidadas', function (Blueprint $table) {
            $table->increments('id');
...
$table->decimal('importe_prestacion_aprobado', 9, 2);
    ...
    {
        Schema::drop('prestaciones.prestaciones_doi_liquidadas');
    }
}
