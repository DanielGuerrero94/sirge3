...
class CreateP03 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.p_03', function (Blueprint $table) {
            $table->increments('id');
            $table->char('estado' , 1);
        ...
        DB::statement('ALTER TABLE prestaciones.p_03 DROP CONSTRAINT p_03_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_03 ADD CONSTRAINT p_03_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
