...
class CreateP13 extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE prestaciones.p_13 DROP CONSTRAINT p_13_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_13 ADD CONSTRAINT p_13_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
