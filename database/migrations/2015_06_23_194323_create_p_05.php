...
class CreateP05 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.p_05', function (Blueprint $table) {
            $table->increments('id');
            $table->char('estado' , 1);
        ...
        DB::statement('ALTER TABLE prestaciones.p_05 DROP CONSTRAINT p_05_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_05 ADD CONSTRAINT p_05_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
