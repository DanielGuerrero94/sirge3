...
class CreateTablePssCodigosPriorizadas extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	...
	public function up()
	{
		Schema::create('pss.codigos_priorizadas', function(Blueprint $table)
		{
	...
	{
		Schema::drop('pss.codigos_priorizadas');
	}
}
