...
class CreateTablePssCodigosOdp extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	...
	public function up()
	{
		Schema::create('pss.codigos_odp', function(Blueprint $table)
		{
			$table->string('codigo_prestacion', 11);
			$table->smallInteger('id_linea_cuidado');
			$table->smallInteger('id_grupo_etario');
			$table->smallInteger('id_odp');
			$table->primary(['codigo_prestacion', 'id_linea_cuidado', 'id_grupo_etario', 'id_odp']);
