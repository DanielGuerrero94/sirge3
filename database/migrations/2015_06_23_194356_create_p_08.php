...
class CreateP08 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prestaciones.p_08', function (Blueprint $table) {
            $table->increments('id');
            $table->char('estado' , 1);
        ...
        DB::statement('ALTER TABLE prestaciones.p_08 DROP CONSTRAINT p_08_pkey;');
        DB::statement('ALTER TABLE prestaciones.p_08 ADD CONSTRAINT p_08_pkey PRIMARY KEY(numero_comprobante, codigo_prestacion, subcodigo_prestacion, fecha_prestacion, clave_beneficiario, orden);');
    }
