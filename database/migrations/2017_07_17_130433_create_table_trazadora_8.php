...
class CreateTableTrazadora8 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trazadoras.trz_8', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index('numero_documento', 'idx_documento_trz_8');
